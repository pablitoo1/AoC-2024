...
const inputFile = "src/day23/day23.txt";
...
const computers = parseInput(lines);

const { setsOf3, part1Result } = solvePart1(computers);
const part2Result = solvePart2(computers, setsOf3);
